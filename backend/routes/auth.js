...
const { sendOtpHandler, verifyOtpHandler, refreshTokenHandler, updateProfile, getMe, logout, verifyKyc } = require('../controllers/authController');
...
router.post('/verify-kyc', auth, verifyKyc);
